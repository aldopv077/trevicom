        ...
        <div class="table-responsive">          
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="password" class="form-control" id="inicio" name="inicio" placeholder="Fecha inicio">
            </div>
            <div class="form-group col-md-4">
              <label for="inputModelo">Fecha fin</label>
              <input type="password" class="form-control" id="fin" name="fin" placeholder="Fecha fin">
            </div>
          </div>
